...
import meter1 from "../../assets/images/HeartBar-01.png";
import meter2 from "../../assets/images/HeartBar-02.png";
import meter3 from "../../assets/images/HeartBar-03.png";
import "./Robot.scss";
...
function Robot({ emote }) {
  const { imageSrc, meterSrc } = emoteMap[emote] || emoteMap.basic;
  return (
    <div className="robot">
      <div className="robot__meter">
        <img className="robot__image-meter" src={meterSrc} alt="meter" />
        <svg
          width="43"
          height="43"
          viewBox="0 0 15 14"
